    ...
    <p>
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="ID" DataSourceID="StaffDetails">
            <Columns>
                ...
                <asp:BoundField DataField="CurrentHours" HeaderText="CurrentHours" SortExpression="CurrentHours" ApplyFormatInEditMode="True" InsertVisible="False" ReadOnly="True" />
                <asp:BoundField DataField="InitialYear" HeaderText="InitialYear" SortExpression="InitialYear" ApplyFormatInEditMode="True" />
            </Columns>
        </asp:GridView>
